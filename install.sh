#!/usr/bin/env sh
# Universal installer for sigmeta. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/sigmeta.git"
echo "Installing sigmeta ..."
